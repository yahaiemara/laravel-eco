    ...
    <section class="my-account container">
      ...
      <div class="row">
        ...
        <div class="col-lg-10">
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <div class="col-6">
                    <a class="btn btn-ms btn-danger" href="{{route('user.order')}}">Back</a>
                </div>
                </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pname">
                                    <div class="image">
                                        <img src="{{asset('upload/product/thumbnails')}}/{{$item->product->image}}" alt="{{$item->product->name}}" class="image">
                                    </div>
                                    <div class="name">
       ...
       <div class="wg-box mt-5 text-right">
        <form action="{{route('usr.order.cancel')}}" method="POST">
            @csrf
            @method('PUT')
       ...
       @elseif($order->status == 'canceled')
         <div class="wg-box mt-5 text-right">
          <p  class="btn btn-success">Order Canceled</p>
          @else
            <div class="wg-box mt-5 text-right">
