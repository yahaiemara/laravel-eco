                    ...
                    <div class="upload-image flex-grow">
                      @if($product->image)
                        <div class="item" id="imgpreview" >
                            <img src="{{asset('upload/product')}}/{{$product->image}}"class="effect8" alt="">
                        </div>
                     @endif
                    ...
                    <div class="upload-image mb-16"> 
                        @if ($product->images)
                            ...
                            <div class="item gitems">
                                <img src="{{asset('upload/product')}}/{{trim($img)}}" alt="">
                            </div>
                            @endforeach
                        @endif   
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                <option value="0"{{$product->stock_status== "instock"?"selected":""}}>InStock</option>
