        ...
        <div class="col-lg-7">
          <div class="product-single__media" data-media-type="vertical-thumbnail">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('upload/product')}}/{{$product->image}}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href=".{{asset('upload/product')}}/{{$product->image}}" data-bs-toggle="tooltip"
                ...
                @foreach (explode(",",$product->images) as $img)
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{asset('upload/product')}}/{{$img}}" width="674"
                      height="674" alt="" />
                      <a data-fancybox="gallery" href="{{asset('upload/product')}}/{{$img}}" data-bs-toggle="tooltip"
                        data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_zoom" />
                      </svg>
            ...
            <div class="product-single__thumbnail">
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset('upload/product/thumbnails')}}/{{$product->image}}" width="104" height="104" alt="" /></div>
                  @foreach (explode(",",$product->images) as $img)
                  <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto" src="{{asset('upload/product/thumbnails')}}/{{$img}}" width="104" height="104" alt="" /></div>
                  @endforeach
        ...
        <div class="col-lg-5">
          ...
          <form name="addtocart-form" action="{{route('cart.add')}}" method="post">
            <div class="product-single__addtocart">
              ...
              <input type="hidden" name="price" value="{{$product->sale_price == ""?$product->regular_price:$product->sale_price}}" id="">
          ...
          <div class="product-single__addtolinks">
            ...
            <form action="{{route('wishlist.remove',Cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId)}}" method="POST" id="removeform">
            @csrf
            @method('DELETE')
              <a href="javascript:void(0)" style="color: orange;padding:10px" class="menu-link menu-link_us-s add-to-wishlist" onclick="document.getElementById('removeform').submit();"><svg width="16" height="16" viewBox="0 0 20 20"
              fill="none" xmlns="http://www.w3.org/2000/svg">
              <use href="#icon_heart" />
            </svg><span>Remove to Wishlist</span></a>
          </form>
            @else
            <form action="{{route('wishlist.add')}}" method="POST" id="wishlist_add">
              @csrf
              <input type="hidden" name="id" value="{{$product->id}}">
              <input type="hidden" name="name" value="{{$product->name}}">
              <input type="hidden" name="price" value="{{$product->sale_price=''?$product->regular_price:$product->sale_price}}">
              <input type="hidden" name="quantity" value="1">
            <a href="javascript:void(0)" class="menu-link menu-link_us-s add-to-wishlist" onclick="document.getElementById('wishlist_add').submit()"><svg width="16" height="16" viewBox="0 0 20 20"
              fill="none" xmlns="http://www.w3.org/2000/svg">
              <use href="#icon_heart" />
            ...
            <div class="swiper-slide product-card">
              <div class="pc__img-wrapper">
                <a href="{{route('shop.details',$product->slug)}}">
                  <img loading="lazy" src="{{asset('upload/product')}}/{{$product->image}}" width="330" height="400"
                    alt="Cropped Faux leather Jacket" class="pc__img">
                    @foreach (explode(",",$product->images) as $img)
                  <img loading="lazy" src="{{asset('upload/product')}}/{{$img}}" width="330" height="400"
              ...
              <div class="pc__info position-relative">
                ...
                @if(Cart::instance('wishlist')->content()->where('id',$product->id)->count()>0)
                <button type="submit" style="color: orange;" class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist"
