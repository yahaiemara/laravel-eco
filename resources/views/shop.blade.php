    ...
    <section class="shop-main container d-flex pt-4 pt-xl-5">
          ...
          <div class="accordion-item mb-4 pb-3">
            ...
            <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
              ...
              <div class="search-field multi-select accordion-body px-0 pb-0">
               <div class="list list-inline mb-0 brand-list">
      ...
      <div class="shop-list flex-grow-1">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size"
              name="pagesize" id="pagesize" style="margin-right: 10px;padding:10px">
        ...
        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" 
              name="orderby" id="orderby" style="padding:10px">
            ...
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <div class="swiper-container background-img js-swiper-slider" data-settings='{"resizeObserver": true}'>
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="{{route('shop.details',$product->slug)}}"><img loading="lazy" src="{{asset('upload/product')}}/{{$product->image}}" width="330"
                          height="400" alt="Cropped Faux leather Jacket" class="pc__img"></a>
                    </div>
                    <div class="swiper-slide">
                        @foreach (explode(",",$product->images) as $img)
                            
                        <a href="{{route('shop.details',$product->slug)}}"><img loading="lazy" src="{{asset('upload/product')}}/{{$img}}"
              ...
              <div class="pc__info position-relative">
                ...
                <form action="{{route('wishlist.remove',Cart::instance('wishlist')->content()->where('id',$product->id)->first()->rowId)}}">
                @csrf
                @method('DELETE')
...
<form action="{{route('shop.index')}}" id="frfilter" method="GET">
